...
export default function AboutSection() {
  return (
    <section id="yritys" className="py-24 bg-gradient-to-b from-sand-white via-warm-rose/20 to-sand-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-dark-muted mb-6 leading-[1.1] tracking-tight max-w-3xl">
            Kankaanpääläistä rakennusosaamista suurella sydämellä
          </h2>
        </motion.div>

        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          {/* Left Column - Text Content with Visual */}
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 pt-8">
              <div className="p-5 bg-white/80 backdrop-blur-sm border border-gray-200/60 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-xs text-meta-text uppercase tracking-wider">Tinkimätön</p>
              </div>
              <div className="p-5 bg-white/80 backdrop-blur-sm border border-gray-200/60 shadow-sm hover:shadow-md transition-shadow">
                <Users className="text-deep-teal mb-3" size={28} />
                <p className="text-xl font-bold text-dark-muted mb-1">Kokemus</p>
                <p className="text-xs text-meta-text uppercase tracking-wider">Vankka</p>
              </div>
            </div>
          </motion.div>
        ...
        {/* Partner Network Cards with Glassmorphism */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
