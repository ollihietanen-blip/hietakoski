    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-20 md:pt-24 overflow-hidden bg-gradient-to-br from-dark-muted via-slate-blue to-dark-muted">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-dark-muted/85 via-slate-blue/75 to-dark-muted/90" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(67,144,147,0.08),transparent_50%)]" />
        </div>

        {/* Decorative elements */}
        <div className="absolute top-20 right-10 w-32 h-32 bg-deep-teal/10 rounded-full blur-3xl hidden lg:block" />
        <div className="absolute bottom-20 left-10 w-40 h-40 bg-warm-rose/10 rounded-full blur-3xl hidden lg:block" />
      ...
      <section className="py-24 md:py-32 bg-sand-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-6 text-dark-muted/80 text-lg md:text-xl leading-relaxed max-w-3xl">
              <p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            ...
            >
              ...
              <p className="text-dark-muted/60 text-sm mt-3 leading-relaxed">
      ...
      <section className="py-24 md:py-32 bg-sand-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-dark-muted/70 text-lg md:text-xl leading-relaxed max-w-3xl mb-8">
              Hietakosken hankkeissa vastuut ovat selkeitä ja ennakoitavia:
            </p>
            <ul className="space-y-4 text-dark-muted/80 text-lg leading-relaxed max-w-3xl mb-8">
      ...
      <section className="py-24 md:py-32 bg-sand-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-dark-muted/70 text-lg md:text-xl leading-relaxed mb-8 max-w-2xl mx-auto">
