  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <ProjectStructuredData
        ...
        url={`/kohteet/${project.slug}`}
        imageUrl={project.imageUrl}
        location={project.location}
        status={project.status}
        price={featuredApartment?.price}
        numberOfRooms={featuredApartment?.rooms}
        floorSize={project.pintaAlat}
      />
      <BreadcrumbStructuredData
        items={[
          { name: t.nav.home, url: '/' },
          { name: t.nav.projects, url: '/kohteet' },
          { name: projectName, url: `/kohteet/${project.slug}` },
        ]}
      />
